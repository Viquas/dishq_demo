...
<div class="navbar-header">
  ...
  <ul class="navbar-icons  pull-right">
      ...
      <li >
          <a class="btn  demo  hidden-md hidden-lg"  id="fade-in"  data-toggle="modal" data-target="#myModal"><span>Demo</span></a>
      </li>
      <li >
          <a class="btn gray thin-shadow btn-right hidden-sm hidden-xs" style="margin-left: 5px;margin-right: 5px" id="fade-in"  data-toggle="modal" data-target="#myModal"><span>Request Demo</span></a>
      </li>
        ...
        <div id="maintagline">
          ...
          <div class="row">
           ...
           <div class="item">
            ...
            <a  class="btn blue thin-shadow up" style="margin-left: 5px;margin-right: 5px"  data-toggle="modal" data-target="#myModal"><span>Request Demo</span></a>
        </div>
    </div>
</div>
</div>

    <div class="section business section-business" id="section1">
        ...
        <p class="quote-details">
          ...
          dishq is a <b>food AI</b> company.<br/>
           We help food businesses provide great food experiences through<b> personalisation.</b><br/>
            ...
            Our unique technology uses <b>food science and rich dish data</b><br/> to deliver <b> highly relevant results</b> to your users.<br/>
  ...
  <div class="row">
    <div class="col-sm-10 col-sm-offset-1">
      <div class="vcenter">
        ...
        <h3 class="white-big white">We Teach Machines To Understand Taste & How It Influences Food Decisions </h3>
...
<div class="section app-section" id="section5">
  <div class="row">
    <div class="col-sm-10 col-sm-offset-1">
...
<div class="section api-section" id="section6">
  <div class="container">
<div class="row ">
  <div class="col-sm-8 col-sm-offset-4">
  <p class="big-title  black-text ">
    API Use Cases
  </p>
  <hr class="green"></hr>
</div>
            ...
            <div class="col-12 col-md-4">
              <ul class="nav nav-vertical">
                <li class="nav-item active">
                  <a class="nav-link " data-toggle="tab" href="#tab-1" aria-expanded="true">
                    <h6 class="points-high">01</h6>
                    <p class="points-low">Notifications truly personalised to drive engagement.</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" data-toggle="tab" href="#tab-2" aria-expanded="false">
                    <h6 class="points-high">02</h6>
                    <p class="points-low">Discovery based upon mood.</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" data-toggle="tab" href="#tab-3" aria-expanded="false">
                    <h6 class="points-high">03</h6>
                    <p class="points-low">
Recommendations intelligently matched to taste.</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" data-toggle="tab" href="#tab-4" aria-expanded="false">
                    <h6 class="points-high">04</h6>
                    <p class="points-low">Restaurant menus curated and organised.</p>
                  </a>
                </li>
              </ul>
            </div>
            ...
            <div class="col-12 col-md-8 align-self-center">
              ...
              <div class="tab-content">
                <div class="tab-pane fade  active in" id="tab-1" aria-expanded="true">
                  <p class="text-center">
                  <img src="images/notify.png" class="img-api"></img>
                 </p>
                </div>

                <div class="tab-pane fade" id="tab-2" aria-expanded="false">
                    <p class="text-center">
                  <img src="images/mob2.png" class="img-api "></img>
                  </p>
                </div>

                <div class="tab-pane fade" id="tab-3" aria-expanded="false">
                    <p class="text-center">
                  <img src="images/mob4.png" class="img-api "></img>
                </p>
                 </div>

                <div class="tab-pane fade" id="tab-4" aria-expanded="false">
                    <p class="text-center">
                  <img src="images/mob3.png" class="img-api "></img>
                </p>
                 </div>
  ...
  <div class="row">
    <div class="col-sm-8 col-sm-offset-2">
      <div class="mar-left">
        ...
        <p class="text-center">
            <a  class="btn blue thin-shadow" style="margin-left: 5px;margin-right: 5px"  data-toggle="modal" data-target="#myModal"><span>Request Demo</span></a>
        </p>
...
<!-- <div class="section app-section" id="section8"> -->
  <!-- <div class="row">

    <div class="col-sm-5 col-sm-offset-2">
      <div class="mar-left">
      <h2 class="big-title  black-text" > Food discovery made personal </h2>
      <hr class="green"></hr>
      <p class="sub-details-lite black-text"><br/>
          Want to test our tech and see your recommendations? Download dishq app and discover food matched to your taste.
    ...
    <div class="col-sm-4 ">
      <p class="text-center">
      <img src="images/match.png" class="img-responsive dishq-app">
    </p>
    </div>
      </div> -->
...
<!-- <div class="section section-footer hidden-lg hidden-md fp-auto-height" id="section9" >
    ...
    <div class="modal-dialog ">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="before-mail">
            <p class="sucess-modal text-center" id="r-message">
              Thank you for your interest in dishq!
              <br/>Please check your email and follow the link.
            </p>
          </div>
          <div class="after-mail">
            ...
            <div class="row">
              <div class="col-sm-10 col-sm-offset-1">
                ...
                <p class="text-center">
                  <input type="email" class="modal-input" placeholder="name@workplace.com" id="r-input"> </input><br/>

                </p>
                <p class="text-center" >
                  <a class="r-demo" id="r-button">Submit </a>
                </p>
              </div>
          </div>
          ...
          <!-- <a type="button" class="  r-demo">Submit</a> -->
...
$('#r-input').on('input', function() {
  if(isEmail($('#r-input').val())){
    $('#r-input').removeClass("red-bottom");
    // $('#r-button').disabled = true;
  }else{
    $('#r-input').addClass("red-bottom");
...
$('#r-button').click(function(){
  ...
  var email = $('#r-input').val();
    if(isEmail(email)){
      request(email);

    }else{
      $( "#r-input" ).effect( "shake" );

    }
});
  function request(email){

    $(".after-mail").fadeOut(500, function () {
        $(".before-mail").fadeIn(500);
    });
    var url = "http://dishq.in/mail.php";
    $.post(url,
        {
          email: email,
