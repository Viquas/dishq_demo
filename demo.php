...
<script>
       ...
       app.controller('searchController', function($scope, $http, $timeout) {
        ...
        var url = "http://dishq.in/mob_demo/index.html?slug="+$scope.slug;
        var url_stall = "http://dishq.in/mob_demo/stal.html";
        var url_personalise = "http://dishq.in/mob_demo/personalise.html?slug="+$scope.slug;
          $("#footer").hide();
          $("#dislike_button").hide();
          $("#dislike_sec").hide();
